...
function FieldSkeleton({ labelWidth, valueWidth }) {
    return (
        <div>
            <div
                className="skeleton"
                style={{ height: 11, width: labelWidth, marginBottom: 6 }}
            />
            <div
                className="skeleton"
                style={{ height: 13, width: valueWidth }}
            />
        </div>
    );
}
    ...
    return (
        <div>
            ...
            >
                ...
                <div
                    className="skeleton"
                    style={{ height: 30, width: 56, borderRadius: 6 }}
                />
            </div>
            <div
                style={{
            ...
            <div
                className="skeleton"
                style={{ height: 11, width: 60, marginBottom: 20 }}
            />
            <div
                style={{
                    display: "grid",
    ...
    return (
        <div>
            ...
            >
                ...
                <div
                    className="skeleton"
                    style={{ height: 30, width: 100, borderRadius: 6 }}
                />
            </div>
            <div
                style={{
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.header}>
                <div
                    className="skeleton"
                    style={{ height: 12, width: 130, marginBottom: 12 }}
                />
                <div
                    style={{
                        display: "flex",
                ...
                >
                    <div
                        className="skeleton"
                        style={{ height: 26, width: 210 }}
                    />
                    <div
                        className="skeleton"
                        style={{ height: 22, width: 64, borderRadius: 5 }}
                    />
                </div>
                <div
                    className="skeleton"
                    style={{ height: 12, width: 270, marginBottom: 6 }}
                />
...
export default function UserDetail({ user, onBack, onUpdateUser }) {
    const { data: profile, loading: profileLoading } = useSimulatedFetch(
        user,
        480,
    );
        ...
        <div className={styles.wrapper}>
            <div className={styles.header}>
                ...
                <div className={styles.headerNameRow}>
                    ...
                    <span
                        ...
                        data-status={profile.accountStatus}
                    >
            ...
            <div className={styles.tabsBar}>
                ...
                >
                    ...
                    <Tab
                        label={`Vehicles (${profile.vehicles.length})`}
                        disableRipple
                    />
