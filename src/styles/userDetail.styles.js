export const sx = {
  wrapper:       { display: "flex", flexDirection: "column", height: "100%", background: "var(--bg)", overflow: "hidden" },
  header:        { flexShrink: 0, px: { xs: 2, md: 3 }, py: { xs: 1.5, md: 2.5 }, background: "var(--surface)", borderBottom: "1px solid var(--border)" },
  headerMain:    { mt: 0.5 },
  headerNameRow: { display: "flex", alignItems: "center", gap: 1.5, flexWrap: "wrap" },
  content:       { flex: 1, minHeight: 0, overflowY: "auto", p: { xs: 2, md: 3 } },
  ...
  tabsBar:       { flexShrink: 0, background: "var(--surface)", borderBottom: "1px solid var(--border)", px: { xs: 0, md: 3 } },
